...
class FormDetector:
        ...
        for field in field_data:
            ...
            if classification and confidence > 0.5:
                mapping = FormMapping(
                    ...
                    cv_path=self.classification_to_cv_path.get(
    ...
    def generate_field_mapping(
        self, cv_data: dict[str, Any], form_fields: list[dict[str, Any]]
    ) -> dict[str, Any]:
        mappings = self.classify_fields(form_fields)

        result = {"mappings": [], "unmapped_fields": [], "confidence_scores": {}}

        mapped_field_names = set()

        for mapping in mappings:
            field_value = self._extract_cv_value(
                cv_data, mapping.cv_path, mapping.transform_function
            )
    ...
    def _apply_transform(
        ...
        data: Any,
        transform_name: str,
        full_cv_data: Optional[dict[str, Any]] = None,
    ) -> str:
